...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  7 16:12:22 2022
...
num = 23   # This number controls which well concentration time series data to use
...
joblib.dump(df, '299-W17-2-Concentration.joblib', compress=4)
...
df = ssa.components_to_df(n= 25)
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W17-2-CTMass.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W17-2-CTAqMass.joblib', compress=4)
