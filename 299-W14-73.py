...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  8 15:30:55 2022
...
num = 30   # This number controls which well concentration time series data to use
...
joblib.dump(df, '299-W14-73-Concentration.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W14-73-CTMass.joblib', compress=4)
...
df = ssa.components_to_df(n = 30)
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W14-73-CTAqMass.joblib', compress=4)
