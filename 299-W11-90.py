...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  6 09:44:47 2022
...
num = 26   # This number controls which well concentration time series data to use
...
joblib.dump(df, '299-W11-90-Concentration.joblib', compress=4)
...
ssa.components_to_df(n = 20)
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W11-90-CTMass.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)  
joblib.dump(df, '299-W11-90-CTAqMass.joblib', compress=4)
