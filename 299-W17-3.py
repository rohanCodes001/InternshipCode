...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 14:14:12 2022
...
joblib.dump(df, '299-W17-3-Concentration.joblib', compress=4)
# %%
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W17-3-CTMass.joblib', compress=4)
...
df = ssa.components_to_df(n = 35)
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W17-3-CTAqMass.joblib', compress=4)
