...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  8 09:23:42 2022
...
num = 14   # This number controls which well concentration time series data to use
...
joblib.dump(df, '299-W12-4-Concentration.joblib', compress=4)

# %%
# Here 2 groups seem to be seen (0 to 27) and (27-40).
ssa.calc_wcorr()
ssa.plot_wcorr()
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W12-4-CTMass.joblib', compress=4)

# %%
# Here 2 groups seem to be seen (0 to 33) and (33-40).
ssa.plot_wcorr()
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W12-4-CTAqMass.joblib', compress=4)
