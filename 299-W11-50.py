...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  8 13:48:31 2022
...
num = 27   # This number controls which well concentration time series data to use
...
joblib.dump(df, '299-W11-50-Concentration.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W11-50-CTMass.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W11-50-CTAqMass.joblib', compress=4)
