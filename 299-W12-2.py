...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  7 15:46:45 2022
...
num = 28   # This number controls which well concentration time series data to use
...
joblib.dump(df, '299-W12-2-Concentration.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W12-2-CTMass.joblib', compress=4)
...
df.set_index(new_dates, inplace = True)
joblib.dump(df, '299-W12-2-CTAqMass.joblib', compress=4)
